...
<link media="all" type="text/css" rel="stylesheet" href="{{asset('resources/assets/css/AdminLTE.min.css')}}">
    ...
    <style type="text/css">
    .login-box,.register-box{width:720px;margin:6% auto}.login-left{border-right:4px solid #ddd}@media (max-width:470px){.login-box,.register-box{width:340px}.login-left{border-right:none}}.or-separator{text-align:center;margin:10px 0;text-transform:uppercase}.or-separator:after,.or-separator:before{content:' -- '}
    </style>
 </head>   
