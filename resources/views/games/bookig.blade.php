                            ...
                            <div class="card-body pt-0">
                                <div class="row">
                                    @foreach($games as $game)
                                        <div class="col-sm-7">
                                            <button class="btn btn-sm btn-primary" data-toggle="modal" data-target="#addTee{{$game->id}}">
                                        ...
                                        <div class="col-sm-5 text-center">
                                            <img src="http://localhost/machakos/public/storage/{{$game->image}}" height="150" width="150">
                                        </div>
                                        <div class="modal fade" id="addTee{{$game->id}}">
                                                    ...
                                                    <div class="modal-body">
                                                        <form class="form-horizontal" action="{{url('viewGame/add')}}" method="post">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="form-group col-md-6">
                                                                    <label for="date_time" class="col-form-label">Time</label>
                                                                    <select name="time_id" class="form-control select2" data-placeholder="Select Tee" data-dropdown-css-class="select2-success" style="width: 100%;">
                                                                        <optgroup label="Time">
